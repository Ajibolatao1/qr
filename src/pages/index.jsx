      ...
      <main>
            ...
            <div
              ...
              <div
                ...
                <div className="d-flex flex-column justify-content-center align-items-center py-2">
                  ...
                  <p>
                    Exports all the information of the scans they have done.
                  </p>
                </div>
              </div>
        ...
        <section className="section3 py-5 bg-secondary">
          <div className="text-center text-light">
            <div className={`top py-3 ${styles.s3top}`}>
          ...
          <Container>
            <Row>
              <Col className="left d-flex justify-content-center" lg={5}>
                <Image
                  src={"/img/qr2.webp"}
                  alt="Qr code"
                  width={400}
                ...
                <Accordion className="w-100">
                  ...
                  <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                      ...
                      is enabled. If you do not have the feature, just download
        ...
        {/* SECTION 4 */}
        <section className="section4 py-5"></section>
      </main>
      <Footer />
    </>
  );
